<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Swietokrzyski.aspx.cs" Inherits="L5._1.Swietokrzyski" %>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <title>Świętokrzyski Park Narodowy</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="#">Świętokrzyski Park Narodowy</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <img src="Image/logo-swietokrzyski.png"class="img-circle" alt="Cinque Terre" width="304" height="236" />
            </div>
            ...
            <div class="col-md-3">
             ...
             <div class="col-md-4 col-md-offset-1">
                 <a href="#" class="thumbnail">
                     ...
                     <img src="Image/swietokrzyski1.jpg" alt="...">
                </a>
                </div>
               <div class="col-md-4 ">
                 <a href="#" class="thumbnail">
                     <img src="Image/swietokrzyski2.jpg" alt="...">
                </a>
                </div>
